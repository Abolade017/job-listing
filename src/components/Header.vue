                ...
                <div class="flex justify-between pt-6 px-10 space-x-48">
                    <div class="flex space-x-6">
                            ...
                            <button class="text-background-desaturated-dark-cyan  flex h-full pl-2 font-bold">frontend <span
                                    ...
                                    <div
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="1.5" stroke="currentColor" class=" w-7 h-7 py-1.5 font-bold">
                        ...
                        <div class="flex"><button
                                class="text-background-desaturated-dark-cyan  flex h-full pl-2 font-bold">frontend
                    ...
                    <div><button
                            class="text-background-desaturated-dark-cyan focus:outline-none hover:underline">clear</button>
                    </div>
                </div>
            </div>
        </div>
